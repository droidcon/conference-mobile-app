...
import static novoda.droidcon2010uk.util.ParserUtils.sanitizeId;
import static novoda.droidcon2010uk.util.ParserUtils.splitComma;
import static novoda.droidcon2010uk.util.ParserUtils.translateTrackIdAlias;
import static novoda.droidcon2010uk.util.ParserUtils.AtomTags.ENTRY;
...
import novoda.droidcon2010uk.util.Lists;
import novoda.droidcon2010uk.util.ParserUtils;
import novoda.droidcon2010uk.util.SpreadsheetEntry;
...
public class RemoteSessionsHandler extends XmlHandler {
    ...
    private static long parseTime(String date, String time) throws HandlerException {
        final String composed = String.format("%s 2010 %s +0100", date, time);
        try {
